    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form action="home.php?search-name=<?php echo $_GET['search-name'] ?>" class="d-flex" method="get">
                ...
                <a class="btn btn-outline-success ml-5" href="signup.php?page=signup-user">signup</a>
                <a class="btn btn-outline-success ml-5" href="login.php?page=login">login</a>
            </form>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img style="height: 350px" src="image/images.jpeg" class="d-block w-100" alt="...">
            </div>
            <div  class="carousel-item">
                <img style="height: 350px" src="image/nh.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img style="height: 350px" src="image/hn.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
